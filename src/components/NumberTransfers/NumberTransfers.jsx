...
import { toggleAll, toggleFilter } from "../store/slices/NumberTransfersSlice"; // Импорт действий из слайса

import cl from "./NumberTransfers.module.scss";

export default function NumberOfTransfers() {
  // Получение состояния фильтров из Redux Store
  const filters = useSelector((state) => state.NumberTransfers);
